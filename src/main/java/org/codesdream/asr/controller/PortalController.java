...
public class PortalController {
    ...
    public String authGet(@PathVariable String appid,
        ...
        log.info(String.format("接收到来自微信服务器的认证消息：signature = [%s], timestamp = [%s], nonce = [%s], echostr = [%s]",
    ...
    public String post(@PathVariable String appid,
        ...
        log.info(String.format("接收微信请求：[msg_signature=[%s], encrypt_type=[%s], signature=[%s]," +
                        " timestamp=[%s], nonce=[%s], requestBody=[%s] ",
